...
import (
	...
	"github.com/ycyxuehan/dashboard-gin/backend/cert"
	...
	"github.com/ycyxuehan/dashboard-gin/backend/handler"
...
func main() {
	...
	engine := gin.New()
	err = handler.CreateHTTPAPIHandler(
		integrationManager,
		clientManager,
		authManager,
		settingsManager,
		systemBannerManager, engine)
	if err != nil {
		handleFatalInitError(err)
	}
