...
import (
	...
	scheme "github.com/ycyxuehan/dashboard-gin/backend/plugin/client/clientset/versioned/scheme"
...
type PluginInterface interface {
	Create( plugin *v1alpha1.Plugin, opts v1.CreateOptions) (*v1alpha1.Plugin, error)
	Update( plugin *v1alpha1.Plugin, opts v1.UpdateOptions) (*v1alpha1.Plugin, error)
	Delete( name string, opts v1.DeleteOptions) error
	DeleteCollection( opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get( name string, opts v1.GetOptions) (*v1alpha1.Plugin, error)
	List( opts v1.ListOptions) (*v1alpha1.PluginList, error)
	Watch( opts v1.ListOptions) (watch.Interface, error)
	Patch( name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Plugin, err error)
	PluginExpansion
}
...
func (c *plugins) Create(plugin *v1alpha1.Plugin, opts v1.CreateOptions) (result *v1alpha1.Plugin, err error) {
	result = &v1alpha1.Plugin{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("plugins").
...
func (c *plugins) Update( plugin *v1alpha1.Plugin, opts v1.UpdateOptions) (result *v1alpha1.Plugin, err error) {
	result = &v1alpha1.Plugin{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("plugins").
...
func (c *plugins) Delete( name string, opts v1.DeleteOptions) error {
...
func (c *plugins) DeleteCollection( opts v1.DeleteOptions, listOpts v1.ListOptions) error {
	var timeout time.Duration
...
func (c *plugins) Patch( name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Plugin, err error) {
	result = &v1alpha1.Plugin{}
