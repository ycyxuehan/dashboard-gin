...
func (c *FakePlugins) Create( plugin *v1alpha1.Plugin, opts v1.CreateOptions) (result *v1alpha1.Plugin, err error) {
	obj, err := c.Fake.
...
func (c *FakePlugins) Update( plugin *v1alpha1.Plugin, opts v1.UpdateOptions) (result *v1alpha1.Plugin, err error) {
	obj, err := c.Fake.
...
func (c *FakePlugins) Delete( name string, opts v1.DeleteOptions) error {
	_, err := c.Fake.
...
func (c *FakePlugins) DeleteCollection( opts v1.DeleteOptions, listOpts v1.ListOptions) error {
...
func (c *FakePlugins) Patch( name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha1.Plugin, err error) {
	obj, err := c.Fake.
